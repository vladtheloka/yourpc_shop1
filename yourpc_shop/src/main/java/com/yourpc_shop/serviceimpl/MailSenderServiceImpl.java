...
{
    private final static String EMAIL_FROM = "lokatheloka@gmail.com"; // your email to sent confirmation to users
    private final static String EMAIL_PASSWORD = "vlad1994"; // your email password
