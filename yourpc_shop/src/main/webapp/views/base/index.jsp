...
<div class="dropdown" style="float: left; padding-left: 10px; margin-top: 10px;">
    ...
    <ul class="dropdown-menu" role="menu" style="margin: 1%; padding: 0; list-style: none">
        <li><span class="mySpan"><spring:message code="label.All"/></span></li>
        <li><span class="mySpan"><spring:message code="label.CPU"/></span></li>
        <li><span class="mySpan"><spring:message code="label.GPU"/></span></li>
        <li><span class="mySpan"><spring:message code="label.RAM"/></span></li>
        <li><span class="mySpan"><spring:message code="label.PSU"/></span></li>
        <li><span class="mySpan"><spring:message code="label.Case"/></span></li>
        <li><span class="mySpan"><spring:message code="label.Storage"/></span></li>
        <li><span class="mySpan"><spring:message code="label.Motherboard"/></span></li>
    </ul>
</div>
